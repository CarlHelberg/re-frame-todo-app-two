...
The `home-routes` handler in the `todo-app-two.routes.home` namespace
...
The `home-page` function will in turn call the `todo-app-two.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/todo_app_two/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `todo-app-two.handler` namespace:
...
Request middleware functions are located under the `todo-app-two.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `todo-app-two.dev-middleware` namespace found in
